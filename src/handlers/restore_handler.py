...
from src.database.db_draft_operations import get_user_state, get_draft
...
async def restore_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Восстанавливает состояние диалога после перезагрузки бота."""
    ...
    # Восстанавливаем данные в context.user_data
