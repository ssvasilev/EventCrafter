...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await send_event_message(event_id, context, query.message.chat_id)
...
# Обработка редактирования лимита
...
def main():
    ...
    application.add_handler(CallbackQueryHandler(edit_description, pattern="^edit_description\|"))
    application.add_handler(CallbackQueryHandler(edit_date, pattern="^edit_date\|"))
    application.add_handler(CallbackQueryHandler(edit_time, pattern="^edit_time\|"))
    application.add_handler(CallbackQueryHandler(edit_limit, pattern="^edit_limit\|"))
    # Запускаем бота
